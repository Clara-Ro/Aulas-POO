...
# O que faz
 ...
 Esse algoritmo tem como objetivo pedir para o usuário digitar um número e então retornar falando se o número digitado é positivo ou negativo. A linguagem usada foi Typescript 
